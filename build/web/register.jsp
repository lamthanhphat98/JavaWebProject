        ...
        <nav class="navbar navbar-inverse navbar-no-bg" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="signup">Bootstrap Registration Form Template</a>
                </div>
                            ...
                            <div class="form-bottom">
                                <form role="form" action="registerUser" method="post" class="registration-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <s:textfield name="txtFullname" placeholder="fullname.." class="form-first-name form-control" id="form-first-name"/>

                                        <!--<input type="text" name="form-last-name" placeholder="fullname..." class="form-last-name form-control" id="form-last-name">-->
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only" for="form-email">Email</label>
                                        <s:textfield name="txtEmail" placeholder="email.." class="form-first-name form-control" id="form-first-name"/>
